...
class StartingFrame():
    def __init__(self, top):
        ...
        def clicked():
            ...
            friend = tk.Label(self.frame, text="Would you like to be my friend?", font=("Comic Sans MS", 15), bg = 'SkyBlue1')
            friend.pack()
...
class Start_Playing():
    def __init__(self, top, response):
        ...
        def play_game():
            lbl = tk.Label(self.frame, text="I live in a house with my mother and father, I have three siblings: Christina, Sally, and Fumi", font=("Comic Sans MS", 15), bg='SkyBlue1')
            lbl.pack(pady = 10)
